  ...
  return (
    <View style={styles.appContainer}>
      ...
      {/* <View style={styles.inputContainer}>
        ...
        <Button title="Add Goal" onPress={() => alert('Hello!')} />
      </View>
      <View>
...
export function Flexbox() {
  return (
    <View style={{ padding: 50, flexDirection: 'column-reverse', width: '80%', height: 300, justifyContent: 'space-between', alignItems: 'stretch' }}>
